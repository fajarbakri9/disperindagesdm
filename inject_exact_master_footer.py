...
def inject_footer_clean(filepath, prefix=""):
    ...
    # Sisipkan tepat sebelum </main> akhir atau sebelum <script pertama atau sebelum </body>
    if "</main>" in html:
        # Sisipkan setelah </main>
        idx = html.rfind("</main>") + len("</main>")
        html = html[:idx] + "\n\n" + rendered + "\n\n" + html[idx:]
    elif "<script" in html:
        # Sisipkan sebelum <script pertama yang ada di bagian bawah
        # Cari script pertama
    ...
    with open(filepath, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"Cleanly injected master footer into: {filepath}")
